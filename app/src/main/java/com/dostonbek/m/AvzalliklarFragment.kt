...
import com.dostonbek.m.databinding.FragmentAvzalliklarBinding

class AvzalliklarFragment : Fragment() {
    private lateinit var binding: FragmentAvzalliklarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAvzalliklarBinding.inflate(layoutInflater, container, false)
        dataList = ArrayList()
        dataList.add(
            PreferenceData(
